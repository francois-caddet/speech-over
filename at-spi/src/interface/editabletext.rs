...
trait EditableText {
    /// CopyText method
    fn copy_text(&self, startPos: i32, endPos: i32) -> zbus::Result<()>;

    /// CutText method
    fn cut_text(&self, startPos: i32, endPos: i32) -> zbus::Result<bool>;

    /// DeleteText method
    fn delete_text(&self, startPos: i32, endPos: i32) -> zbus::Result<bool>;
    ...
    fn set_text_contents(&self, newContents: &str) -> zbus::Result<bool>;
}
