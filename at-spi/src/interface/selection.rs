...
trait Selection {
    ...
    fn deselect_child(&self, childIndex: i32) -> zbus::Result<bool>;

    /// DeselectSelectedChild method
    fn deselect_selected_child(&self, selectedChildIndex: i32) -> zbus::Result<bool>;

    /// GetSelectedChild method
    fn get_selected_child(
        &self,
        selectedChildIndex: i32,
    ) -> zbus::Result<(String, zbus::zvariant::OwnedObjectPath)>;

    /// IsChildSelected method
    fn is_child_selected(&self, childIndex: i32) -> zbus::Result<bool>;

    /// SelectAll method
    fn select_all(&self) -> zbus::Result<bool>;

    /// SelectChild method
    fn select_child(&self, childIndex: i32) -> zbus::Result<bool>;
